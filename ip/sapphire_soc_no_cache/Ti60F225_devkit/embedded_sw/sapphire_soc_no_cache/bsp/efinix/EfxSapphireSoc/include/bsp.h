...
#define ENABLE_FLOATING_POINT_SUPPORT       0 // Enable the supports for floating point printing. Only applicable for BSP_PRINTF and BSP_PRINTF_FULL    // Default: Disable
